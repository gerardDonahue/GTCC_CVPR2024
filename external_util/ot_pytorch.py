"""
    This file is obtained from the following github:
        https://github.com/rythei/PyTorchOT/blob/master/ot_pytorch.py
"""
...
def sink(M, reg, numItermax=1000, stopThr=1e-9, cuda = True):
    ...
    return 1000000 * torch.sum(u.view((-1, 1)) * K * v.view((1, -1))) / (Nini * Nfin), T
